...
public class RecyclerViewAdapter_apropos extends RecyclerView.Adapter<RecyclerViewAdapter_apropos.ContactViewHolder> {

    List<Information> contents=new ArrayList<Information>();
    Activity activity;
    public RecyclerViewAdapter_apropos(List<Information> contents, Activity activity) {
    ...
    @Override
    public RecyclerViewAdapter_apropos.ContactViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_item_card_apropos, parent, false);
        ...
        return new RecyclerViewAdapter_apropos.ContactViewHolder(view) {
        };
    }
