...
public class Grid2RecyclerViewAdapter extends RecyclerView.Adapter<Grid2RecyclerViewAdapter.ContactViewHolder> {

    List<Information> contents=new ArrayList<Information>();
    Activity activity;
    public Grid2RecyclerViewAdapter(List<Information> contents, Activity activity) {
    ...
    @Override
    public Grid2RecyclerViewAdapter.ContactViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.grid2_list_item_card, parent, false);
        ...
        return new Grid2RecyclerViewAdapter.ContactViewHolder(view) {
        };
    }
