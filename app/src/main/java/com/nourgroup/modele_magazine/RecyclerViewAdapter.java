...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.ContactViewHolder> {
    ...
    Activity activity;
    public RecyclerViewAdapter(List<Information> contents, Activity activity) {
    ...
    @Override
    public RecyclerViewAdapter.ContactViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new RecyclerViewAdapter.ContactViewHolder(view) {
        };
    }
