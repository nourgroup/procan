...
public class GridRecyclerViewAdapter extends RecyclerView.Adapter<GridRecyclerViewAdapter.ContactViewHolder> {

    List<Information> contents=new ArrayList<Information>();
    Activity activity;
    public GridRecyclerViewAdapter(List<Information> contents, Activity activity) {
    ...
    @Override
    public GridRecyclerViewAdapter.ContactViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.grid_list_item_card, parent, false);
        ...
        return new GridRecyclerViewAdapter.ContactViewHolder(view) {
        };
    }
